...
public class ProductsPage {
    ...
    public void addItemToTheCart(String productName){
        String xpatOfElementToBeAdded = String.format(ADD_TO_CART_LOCATOR, productName);
        WebElement addToCartButton = driver.findElement(By.xpath(xpatOfElementToBeAdded));
